...
test ('unknown ns', () => {
	...
	messUp ('"http://rosreestr.ru/services/v0.18/TStatementRequestEGRN"', '"http://tempuri.org"', 'Unknown namespace: http://tempuri.org')

})

test ('unknown root element', () => {

	messUp (':EGRNRequest', ':OGRNRequest', 'OGRNRequest is not found in http://rosreestr.ru/services/v0.18/TStatementRequestEGRN')

})

test ('root not element', () => {

	messUp (':EGRNRequest', ':TEGRNRequest', 'is not found')

})

test ('Unexpected element', () => {

	messUp ('<ns4:actionCode>', '<ns26:inn>7842111111</ns26:inn><ns4:actionCode>', 'Unexpected element')

})

test ('Unexpected element', () => {

	messUp ('<ns4:actionCode>659511111112</ns4:actionCode>', '<ns4:actionCode><ns4:actionCode>659511111112</ns4:actionCode></ns4:actionCode>', 'No nested')

})

test ('Unknown attribute', () => {

	messUp ('_id=', '_iddqd=', 'Unknown attribute')

})

test ('Missing required attribute', () => {

	messUp ('_id="c543c4c1-6dd4-e8a7-7441-e66f394ae716"', '', 'Missing required attribute')
