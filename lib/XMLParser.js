		...
		for (const node of nodes) {
			...
			switch (type) {
				...
				case SAXEvent.TYPES.END_ELEMENT:
					...
					if (this.element === null)          throw new Error (nodes.linePos.format ('XML-00002'))
					if (this.element.name != node.name) throw new Error (nodes.linePos.format ('XML-00003', [this.element.name]))
