...
const VOCABULARY = new Map ([
	...
	['XVS-00004', `The value '%s' is %i %s long, which exceeds the allowed maximum of %i`],
	['XVS-00005', `The value '%s' is %i %s long, which is less than the allowed minimum of %i`],
	['XVS-00006', `The value '%s' is %i %s long, must be exaclty %i`],
