...
const XSComplexType = require ('./XSComplexType.js')
...
const XMLSchemata = class extends Map {
	...
	getComplexType (node) {
		...
		if ('_xsComplexType' in node) return node._xsComplexType

		return node._xsComplexType = new XSComplexType (this, node)
