...
SOAP11.fault = (faultstring, o = {}) => {

	let {code} = o
	if (code == null) code = 'Server'
	if (typeof code === 'string') code = {localName: code, namespaceURI: 'http://schemas.xmlsoap.org/soap/envelope/'}

	let Fault = {faultstring, faultcode: code}

	if ('actor'  in o) Fault.faultactor = o.actor
	if ('detail' in o) Fault.detail = XMLSchemata.any (o.detail)
