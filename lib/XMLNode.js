...
const XMLNode = class extends SAXEvent {
	...
	toString (options, level = 0) {
		...
		if (arguments.length !== 0) return this.toFormattedString (options, level).trimStart ()
	...
	toFormattedString (options, level = 0) {
		...
		if (this.type === SAXEvent.TYPES.END_ELEMENT) {

			if (options.space == null) options.space = 0
			...
			return ESC_BODY.escape (this.src)
