...
class DT7 {
	...
	constructor (src) {
		...
		const t = typeof src; if (t !== 'string') throw Error (`The Seven-property Date Time Model can only be constructed from a string`)
	...
	validateYear () {
		...
		if (year.charCodeAt (base) === CH_0 && length - base !== 4) throw Error (`Startin with 0, the year must have exactly 4 digits`)
