...
## 7.2 Core API: Low-Level Methods
...
## 7.3 Convenience Method: `writeNode(node)`
...
## 7.4 Using XMLPrinter: In-Memory Generation
...
## 7.5 Using XMLStreamPrinter: Streaming to a Destination
...
## 7.6 Escaping and Well-Formedness Guarantees
...
In the spirit of perfectly pure [XML 1.0](https://www.w3.org/TR/xml/) (thus [without any idea about namespaces](http://www.jclark.com/xml/xmlns.htm)), the low-level API treats element and attribute names as opaque strings. You may include colons (e.g., `'xsi:type'`) manually:
...
## 7.8 Complete Example: Generating a Feed Document
